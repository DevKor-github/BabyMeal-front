...
class FridgeService extends ChangeNotifier {
  ...
  Future<bool?> enrollIngredients(
      String ingredient, bool active, String emoticon) async {
  ...
  Future<dynamic> getCustomerSort() async {
    ...
    String? token = sharedPreferences.getString("access_token");
    try {
      Response response = await Dio().get("$baseUrl/fridge/customer",
  ...
  Future<dynamic> getNewSort() async {
    ...
    String? token = sharedPreferences.getString("access_token");
    try {
      Response response = await Dio().get("${baseUrl}/fridge/customer/new",
          options: Options(headers: {
            "Authorization": 'Bearer $token',
            "Content-Type": 'application/json'
          }));
  ...
  Future<bool> updateIngredient(
      int fridgeId, String ingredients, bool exist, String emoticon) async {
    // 재료 수정
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    String? token = sharedPreferences.getString("access_token");
  ...
  Future<bool> deleteIngredient(int fridgeId) async {
    ...
    try {
      Response response = await Dio().delete("$baseUrl/fridge",
          data: data,
          options: Options(headers: {
            "Authorization": 'Bearer $token',
            "Content-Type": 'application/json'

...
class MyPageService extends ChangeNotifier {
  ...
  var url = Uri.parse('http://ec2-43-200-210-159.ap-northeast-2.compute.amazonaws.com:8080/customer/baby');
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse['data'][0] != null) {
        var newBabyId = jsonResponse['data'][0]['babyId'].toString(); // int를 String으로 변환
      ...
      throw Exception('Failed to load babyId with status code ${response.statusCode}');
    }
  } catch (e) {

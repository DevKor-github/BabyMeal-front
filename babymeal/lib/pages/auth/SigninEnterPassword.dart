...
class _SigninEnterPassword extends State<SigninEnterPassword> {
                      ...
                      Center(
                          child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                  minimumSize: Size(phoneUnitWidth * 310, phoneUnitHeight * 55),
    ...
    Widget build(BuildContext context) {
      ...
      return Scaffold(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: isValidPassword(_passwordController.text) ? Color(0xffff5c39) : Color.fromRGBO(189, 189, 189, 1),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
                    ),
                    textStyle: TextStyle(
        ...
        body: Container(
          padding: EdgeInsets.fromLTRB(phoneUnitWidth * 16, phoneUnitHeight * 44, phoneUnitWidth * 16, phoneUnitHeight * 40),
          child: Column(

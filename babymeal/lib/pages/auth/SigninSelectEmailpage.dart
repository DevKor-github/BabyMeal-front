  ...
  Widget build(BuildContext context) {
    ...
    final List<List<TextSpan>> titles = [
      [
        ...
        TextSpan(text: 'AI 유아식 추천', style: TextStyle(color: Color(0xFFFF5C39)))
      ],
      [
        TextSpan(text: '더욱 알뜰하게\n', style: TextStyle(color: Color(0xFF000000))),
        TextSpan(text: '냉장고 재료', style: TextStyle(color: Color(0xFFFF5C39))),
        TextSpan(text: ' 기반 추천', style: TextStyle(color: Color(0xFF000000))),
      ],
      [
        TextSpan(
            text: '육아 선배들의\n숨은 레시피, 꿀팁까지',

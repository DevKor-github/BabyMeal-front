...
class _ViewMyPageWidgetState extends State<ViewMyPageWidget> {
  ...
  Future<void> fetchCustomerInfo() async {
    ...
    final response = await http.get(
      Uri.parse('http://ec2-43-200-210-159.ap-northeast-2.compute.amazonaws.com:8080/customer/my'),
      headers: {
  ...
  if (customer?.rank == "초보") {
    return Container(
                padding:
                    EdgeInsets.only(left: 20, top: 18, right: 20, bottom: 21),
                child: Column(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                  ...
                                                  child: Text(
                                                    customer?.rank == '초보' ? '10' :
                                                    customer?.rank == '요리사' ? '50' :
                                                    customer?.rank == '주방장' ? '100' : '0',
                                                    style: TextStyle(
                                                      color: Color(0xFF757575),
                                                      fontSize: 14,
                                                      fontFamily: 'Pretendard',

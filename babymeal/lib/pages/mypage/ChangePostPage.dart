...
class ChangePostPageWidget extends StatefulWidget {
  const ChangePostPageWidget({
    super.key,
    required this.postId,
  });
  final int postId;
  @override
  State<ChangePostPageWidget> createState() => _ChangePostPageWidgetState();
}

class _ChangePostPageWidgetState extends State<ChangePostPageWidget> {

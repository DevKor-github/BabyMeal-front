...
class _ViewRefrigeratorPageWidgetState
  ...
  void searchIngredient(String? search) {
    _tiles = List.generate(ingredient.length, (index) {
      if (search != null &&
          search.isNotEmpty &&
  ...
  void _showIngredient(int index) async {
    ...
    TextEditingController? editEmojiController =
        TextEditingController(text: uniqueIngredient["emoticon"]);
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          bool success = await FridgeService()
                              .deleteIngredient(ingredient[index]["fridgeId"]);
                          if (success == true) {
                            _updateIngredientSort();
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Switch.adaptive(
                            ...
                            onChanged: (bool newValue) =>
                                setState(() => _ingredientExist = newValue)),
                      )
                    ],
                  ),
                  Padding(

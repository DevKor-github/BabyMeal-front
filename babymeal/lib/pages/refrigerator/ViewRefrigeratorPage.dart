...
class _ViewRefrigeratorPageWidgetState
  ...
  Future<void> editIngredient(Map<String, dynamic> ingredient) async {
    bool success = await FridgeService().updateIngredient(ingredient["fridgeId"], ingredient["ingredients"], ingredient["exist"], ingredient["emoticon"]);
    if (success){
      setState(() {
        _updateIngredientSort();
      });
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Switch.adaptive(
                                ...
                                onChanged: (bool newValue) => setState(() => uniqueIngredient["active"] = newValue)),
                          )
                        ],
                      ),
                      Padding(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              bool? success = await FridgeService().updateIngredient(uniqueIngredient["fridgeId"], _ingredientController!.text, uniqueIngredient["active"], emojiController!.text);
                              if(success == true) {
                                Navigator.pop(context);
                              }
                            },
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              bool? success = await FridgeService().enrollIngredients(_ingredientController!.text, _ingredientExist, emojiController!.text);
                              if(success == true) {
                                Navigator.pop(context);
                              }
                            },

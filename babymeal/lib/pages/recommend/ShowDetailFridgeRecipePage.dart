...
class _ShowDetailRecipePageWidgetState extends State<ShowDetailFridgeRecipePageWidget> {
  ...
  String fridge = widget.selectedMaterials.join(','); // selectedMaterials를 콤마로 구분된 문자열로 변환
  ...
  Future<void> fetchRecipeDetails(String token, String fridge, String keyword) async {
    print(widget.simpleDietId);
    var url = Uri.parse('http://ec2-43-200-210-159.ap-northeast-2.compute.amazonaws.com:8080/diet/detail?simpleDietId=${widget.simpleDietId}');
    // print(url);
    var body = jsonEncode({
      'fridge': fridge,
      'keyword': keyword,

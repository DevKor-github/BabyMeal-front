...
Future<void> _loadRecipes() async {
  ...
  try {
    ...
    var tempRecipes = await dietService.fetchRefrigeratorRecipes(babyId); // 여기서 메소드 호출
...
Future<void> onHeartChangedFridgeRecipe(int? simpleDietId, bool newHeartValue) async {
  final recipeIndex = fridgeRecipes.indexWhere((recipe) => recipe.simpleDietId == simpleDietId);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                ListView.builder(
                shrinkWrap: true,
                itemCount: fridgeRecipes.length, // fridgeRecipes 리스트의 길이로 아이템 개수 설정
                itemBuilder: (context, index) {
                  FridgeRecipe fridgeRecipe = fridgeRecipes[index]; // 현재 인덱스의 레시피 객체
                  return Container(
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: ImageIcon(
                              ...
                              color: fridgeRecipe.heart ?? false ? Colors.red : Colors.grey,
                            ),
                          ),
                        ),
                      ],
...
class RefrigeratorRecipe extends StatelessWidget {
  ...
  const RefrigeratorRecipe({Key? key, required this.fridgeRecipe, required this.fridgeRecipes, required this.onHeartChanged}) : super(key: key);
